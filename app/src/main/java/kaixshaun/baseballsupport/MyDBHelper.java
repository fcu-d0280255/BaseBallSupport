...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_Record_TABLE = "CREATE TABLE IF NOT EXISTS Record(_id INTEGER PRIMARY KEY AUTOINCREMENT,GameID TEXT NOT NULL,TeamID TEXT NOT NULL,Back INTEGER,Inning  INTEGER,Round  INTEGER,_No  INTEGER,Situation TEXT,Flyto  INTEGER,Out  INTEGER,RBI  INTEGER,Notes TEXT)";
