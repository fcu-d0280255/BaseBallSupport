...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_BattingOrder_TABLE = "CREATE TABLE IF NOT EXISTS BattingOrder (_id INTEGER PRIMARY KEY AUTOINCREMENT,GameID TEXT NOT NULL,TeamID TEXT NOT NULL,Back,Order,Rule)";
    public static final String CREATE_Teammate_TABLE = "CREATE TABLE IF NOT EXISTS Teammate (_id INTEGER PRIMARY KEY AUTOINCREMENT,GameID TEXT NOT NULL,TeamID TEXT NOT NULL,Back,S_B)";
