...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_BattingOrder_TABLE = "CREATE TABLE IF NOT EXISTS BattingOrder(_id INTEGER PRIMARY KEY AUTOINCREMENT,GameID TEXT NOT NULL,TeamID TEXT NOT NULL,Back  INTEGER,Order  INTEGER,Rule  INTEGER);";
    public static final String CREATE_Teammate_TABLE = "CREATE TABLE IF NOT EXISTS Teammate(_id INTEGER PRIMARY KEY AUTOINCREMENT,GameIDTEXT NOT NULL,TeamID TEXT NOT NULL,Back  INTEGER,S_B TEXT);";
    public static final String CREATE_Record_TABLE = "CREATE TABLE IF NOT EXISTS Record(_id INTEGER PRIMARY KEY AUTOINCREMENT,GameID TEXT NOT NULL,TeamID TEXT NOT NULL,Back INTEGER,Inning  INTEGER,Round  INTEGER,Order  INTEGER,Situation TEXT,Flyto  INTEGER,Out  INTEGER,RBI  INTEGER,Notes TEXT)";
    public static final String CREATE_FinalData_TABLE = "CREATE TABLE IF NOT EXISTS FinalData(_id INTEGER PRIMARY KEY AUTOINCREMENT,GameID TEXT NOT NULL,TeamID TEXT NOT NULL,Back  INTEGER,Order  INTEGER,rule  INTEGER,PA INTEGER,BA REAL,OBP REAL,Hit INTEGER,Walk INTEGER,Error INTEGER,RBI INTEGER)";
